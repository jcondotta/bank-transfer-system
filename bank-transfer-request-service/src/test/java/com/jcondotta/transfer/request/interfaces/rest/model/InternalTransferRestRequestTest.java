...
class InternalTransferRestRequestTest {
    ...
    void shouldNotDetectViolation_whenRequestIsValid(Currency currency) {
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), RECIPIENT_IBAN.value(), AMOUNT_200, currency.name(), TRANSFER_REFERENCE);
    ...
    void shouldDetectConstraintViolation_whenBankAccountIdIsNull(Currency currency) {
        var request = new InternalTransferRestRequest(null, RECIPIENT_IBAN.value(), AMOUNT_200, currency.name(), TRANSFER_REFERENCE);
    ...
    void shouldDetectConstraintViolation_whenRecipientIbanIsNull(Currency currency) {
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), null, AMOUNT_200, currency.name(), TRANSFER_REFERENCE);
    ...
    void shouldDetectConstraintViolation_whenRecipientIbanIsInvalid(String invalidIban) {
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), invalidIban, AMOUNT_200, Currency.EUR.name(), TRANSFER_REFERENCE);
    ...
    void shouldDetectConstraintViolation_whenAmountIsNull(Currency currency) {
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), RECIPIENT_IBAN.value(), null, currency.name(), TRANSFER_REFERENCE);
    ...
    void shouldDetectConstraintViolation_whenAmountIsNegative(BigDecimal amount, Currency currency) {
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), RECIPIENT_IBAN.value(), amount, currency.name(), TRANSFER_REFERENCE);
    ...
    void shouldDetectConstraintViolation_whenCurrencyIsNull() {
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), RECIPIENT_IBAN.value(), AMOUNT_200, null, TRANSFER_REFERENCE);
    ...
    void shouldDetectConstraintViolation_whenCurrencyFormatIsInvalid(String invalidCurrency) {
        var request = new InternalTransferRestRequest(
    ...
    void shouldNotDetectConstraintViolation_whenReferenceIsNull(Currency currency) {
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), RECIPIENT_IBAN.value(), AMOUNT_200, currency.name(), null);
    ...
    void shouldNotDetectConstraintViolation_whenReferenceIsEmpty(Currency currency) {
        var blankReference = "   ";
        var request = new InternalTransferRestRequest(SENDER_ACCOUNT_ID.value(), RECIPIENT_IBAN.value(), AMOUNT_200, currency.name(), blankReference);
