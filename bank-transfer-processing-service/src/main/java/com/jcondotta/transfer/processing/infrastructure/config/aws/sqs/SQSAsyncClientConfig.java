package com.jcondotta.transfer.processing.infrastructure.config.aws.sqs;
...
public class SQSAsyncClientConfig {
    ...
    public SqsAsyncClient sqsAsyncClientLocal(
        AwsCredentialsProvider credentialsProvider, Region region, @Value("${cloud.aws.sqs.endpoint}") String endpoint) {
